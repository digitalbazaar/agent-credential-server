 ...
 * @property {string} privateKeyBase64url Base64url-encoded Ed25519 private key (32 bytes)
 ...
 * @property {CredentialStatus} [credentialStatus] Optional credential status for revocation support
 */
