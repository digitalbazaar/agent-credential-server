...
describe('extractEd25519Key', () => {
  ...
  it('extracts key from publicKeyMultibase ' +
    '(z-prefix base58btc with multicodec)', async () => {
    const {publicKey} = await generateKeyPair();
    // Construct a valid multibase: multicodec prefix 0xed 0x01 + raw
    // public key, base58btc encoded
...
/**
 * Base58btc encoder (Bitcoin alphabet) — mirrors the decoder in verify.js.
 *
 * @param {Uint8Array} bytes - The bytes to encode.
 * @returns {string} The base58btc-encoded string.
 */
