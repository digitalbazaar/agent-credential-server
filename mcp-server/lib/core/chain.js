...
import { verifyCredentialJwt, parseCredential } from "./vc.js";
...
/**
 * @param {ChainLink[]} links
 * @param {string} leafAgentDid
 * @param {number} [maxDepth=5]
 * @returns {Promise<{valid: boolean, depth: number, chain?: ChainEntry[], reason?: string}>}
 */
