...
// the three pipeline steps and their state, derived from how far we have run
  ...
  <main>
    <header>
      ...
      <p class="sub">
        ...
        against the issuer's DID — no central registry. Pick a scenario and
        watch it pass or fail. The verdict is the server's, not this page's.
      </p>
    </header>
    ...
    <section v-if="scenario" class="result">
